...
import Award from "@/components/Pdf/Award";
import Education from "@/components/Pdf/Education";
import Experience from "@/components/Pdf/Experience";
import Header from "@/components/Pdf/Header";
import Project from "@/components/Pdf/Project";
import Skill from "@/components/Pdf/Skill";
...
export default function MyDocument({ data }: { data: ResumeProp }) {
